                            ...
                            <table id="sectorList" class="table table-striped table-bordered table-hover">
                                ...
                                @foreach($sectors as $sector)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a title='Edit' class='btn btn-info' href='{{url("/accounting/sectoredit")}}/{{$sector->id}}'> <i class="glyphicon glyphicon-edit icon-white"></i></a>&nbsp&nbsp<a title='Delete' class='btn btn-danger delete' href='{{url("/accounting/sectordelete")}}/{{$sector->id}}'> <i class="glyphicon glyphicon-trash icon-white"></i></a>
                                        </td>
                                @endforeach
                                </tbody>
                            </table>
