    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div data-original-title="" class="box-header well">
                <h2><i class="glyphicon glyphicon-book"></i> Accounting Balance</h2>
                        ...
                        <div class="col-md-5">
                            <div class="form-group ">
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="{{date('Y-m-d')}}" type="text" id="fdate"  class="form-control datepicker" name="fromDate"   data-date-format="yyyy-mm-dd">
                                </div>
                        ...
                        <div class="col-md-5">
                            <div class="form-group ">
                                ...
                                <div class="input-group">
                                    ...
                                    <input  value="{{date('Y-m-d')}}" type="text" id="tdate"   class="form-control datepicker" name="toDate"   data-date-format="yyyy-mm-dd">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i> </span>
                                </div>
